...
inline constexpr DebugViewDoc kRaytraceDebugModeDocs[] = {
	...
	{"PathTracingPass bounce sampling (NaN sentinel)",
	 "all green; other colors = NaN bounce direction by cause",
	 "classifies NaNs in the sampled bounce direction (see BounceHealthColor)"},
};
